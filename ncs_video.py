...
with open('../realtime-object-detection/graphs/mobilenetgraph', mode="rb") as f:
...
vs = cv2.VideoCapture('videoplayback1.mp4')
time.sleep(1)
fps = FPS().start()
...
while (vs.isOpened()):
    ...
    for (i, pred) in enumerate(predictions):
        ...
        txt = 'FPS:' + str(1/fr_ps)
        cv2.putText(image_for_result, txt, (100,100), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (255, 255, 255))
